...
Travis Continuous Integration Server status: https://travis-ci.org/jnorthr/LoggingExamples.svg?branch=master[Build Status](https://travis-ci.org/jnorthr/LoggingExamples)
